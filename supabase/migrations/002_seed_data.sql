...
-- Product Features (for security products 1-8)
INSERT INTO product_features (product_id, feature, sort_order) VALUES
((SELECT id FROM products WHERE legacy_id = 1), 'Hình ảnh Full HD 2MP sắc nét', 1),
((SELECT id FROM products WHERE legacy_id = 1), 'Công nghệ ColorVu - màu 24/7', 2),
((SELECT id FROM products WHERE legacy_id = 1), 'Chuẩn chống nước IP67', 3),
((SELECT id FROM products WHERE legacy_id = 1), 'Hỗ trợ PoE cấp nguồn qua mạng', 4),
((SELECT id FROM products WHERE legacy_id = 1), 'Tầm xa hồng ngoại 30m', 5),
((SELECT id FROM products WHERE legacy_id = 2), 'Dung lượng 3.000 vân tay', 1),
((SELECT id FROM products WHERE legacy_id = 2), 'Lưu 100.000 bản ghi chấm công', 2),
((SELECT id FROM products WHERE legacy_id = 2), 'Kết nối USB và TCP/IP', 3),
((SELECT id FROM products WHERE legacy_id = 2), 'Phần mềm quản lý miễn phí', 4),
((SELECT id FROM products WHERE legacy_id = 3), '5 phương thức mở khóa', 1),
((SELECT id FROM products WHERE legacy_id = 3), 'Vân tay, mã PIN, thẻ từ, chìa, Bluetooth', 2),
((SELECT id FROM products WHERE legacy_id = 3), 'Thiết kế sang trọng, chống trộm', 3),
((SELECT id FROM products WHERE legacy_id = 3), 'Pin dự phòng khi mất điện', 4),
((SELECT id FROM products WHERE legacy_id = 4), 'Hỗ trợ 8 kênh camera IP', 1),
((SELECT id FROM products WHERE legacy_id = 4), 'Độ phân giải tối đa 4MP', 2),
((SELECT id FROM products WHERE legacy_id = 4), 'Hỗ trợ 1 ổ cứng SATA 6TB', 3),
((SELECT id FROM products WHERE legacy_id = 4), 'Xem từ xa qua điện thoại', 4),
((SELECT id FROM products WHERE legacy_id = 5), 'Xoay 360 độ, theo dõi chuyển động', 1),
((SELECT id FROM products WHERE legacy_id = 5), 'Đàm thoại 2 chiều', 2),
((SELECT id FROM products WHERE legacy_id = 5), 'Phát hiện chuyển động thông minh', 3),
((SELECT id FROM products WHERE legacy_id = 5), 'Hỗ trợ thẻ nhớ 256GB', 4),
((SELECT id FROM products WHERE legacy_id = 6), 'Phạm vi liên lạc 5km', 1),
((SELECT id FROM products WHERE legacy_id = 6), 'Pin dung lượng cao, dùng 12h', 2),
((SELECT id FROM products WHERE legacy_id = 6), 'Chống nước, chống bụi IP54', 3),
((SELECT id FROM products WHERE legacy_id = 7), 'Nhận diện khuôn mặt dưới 0.5s', 1),
((SELECT id FROM products WHERE legacy_id = 7), 'Lưu trữ 1.500 khuôn mặt', 2),
((SELECT id FROM products WHERE legacy_id = 7), 'Màn hình cảm ứng 7 inch', 3),
((SELECT id FROM products WHERE legacy_id = 7), 'Kết nối WiFi, TCP/IP', 4),
((SELECT id FROM products WHERE legacy_id = 8), 'Trung tâm báo cháy + 8 đầu báo khói', 1),
((SELECT id FROM products WHERE legacy_id = 8), 'Phát hiện khói và nhiệt độ', 2),
((SELECT id FROM products WHERE legacy_id = 8), 'Còi báo động 85dB', 3),
((SELECT id FROM products WHERE legacy_id = 8), 'Đạt tiêu chuẩn PCCC', 4);

-- Product Specs (for security products 1-8)
INSERT INTO product_specs (product_id, spec_key, spec_value, sort_order) VALUES
((SELECT id FROM products WHERE legacy_id = 1), 'Độ phân giải', '2MP (1920x1080)', 1),
((SELECT id FROM products WHERE legacy_id = 1), 'Ống kính', '2.8mm / 4mm', 2),
((SELECT id FROM products WHERE legacy_id = 1), 'Hồng ngoại', '30m, ColorVu', 3),
((SELECT id FROM products WHERE legacy_id = 1), 'Chống nước', 'IP67', 4),
((SELECT id FROM products WHERE legacy_id = 1), 'Nguồn', 'PoE (802.3af) / 12V DC', 5),
((SELECT id FROM products WHERE legacy_id = 2), 'Dung lượng vân tay', '3.000', 1),
((SELECT id FROM products WHERE legacy_id = 2), 'Bản ghi', '100.000', 2),
((SELECT id FROM products WHERE legacy_id = 2), 'Kết nối', 'USB, TCP/IP', 3),
((SELECT id FROM products WHERE legacy_id = 2), 'Màn hình', 'LCD 3.5 inch', 4),
((SELECT id FROM products WHERE legacy_id = 3), 'Phương thức mở', 'Vân tay, PIN, Thẻ từ, Chìa, Bluetooth', 1),
((SELECT id FROM products WHERE legacy_id = 3), 'Dung lượng vân tay', '100', 2),
((SELECT id FROM products WHERE legacy_id = 3), 'Chất liệu', 'Hợp kim kẽm, kính cường lực', 3),
((SELECT id FROM products WHERE legacy_id = 3), 'Pin dự phòng', '4 pin AA', 4),
((SELECT id FROM products WHERE legacy_id = 4), 'Số kênh', '8 kênh IP', 1),
((SELECT id FROM products WHERE legacy_id = 4), 'Độ phân giải tối đa', '4MP', 2),
((SELECT id FROM products WHERE legacy_id = 4), 'Ổ cứng', '1x SATA, tối đa 6TB', 3),
((SELECT id FROM products WHERE legacy_id = 4), 'Băng thông', '80Mbps', 4),
((SELECT id FROM products WHERE legacy_id = 5), 'Độ phân giải', '2MP (1920x1080)', 1),
((SELECT id FROM products WHERE legacy_id = 5), 'Xoay', '360° ngang, 90° dọc', 2),
((SELECT id FROM products WHERE legacy_id = 5), 'Kết nối', 'WiFi 2.4GHz', 3),
((SELECT id FROM products WHERE legacy_id = 5), 'Lưu trữ', 'MicroSD tối đa 256GB', 4),
((SELECT id FROM products WHERE legacy_id = 6), 'Tần số', 'VHF/UHF', 1),
((SELECT id FROM products WHERE legacy_id = 6), 'Công suất', '5W', 2),
((SELECT id FROM products WHERE legacy_id = 6), 'Phạm vi', '~5km', 3),
((SELECT id FROM products WHERE legacy_id = 6), 'Pin', 'Li-ion 2000mAh', 4),
((SELECT id FROM products WHERE legacy_id = 7), 'Nhận diện', 'Khuôn mặt, vân tay, mật khẩu', 1),
((SELECT id FROM products WHERE legacy_id = 7), 'Dung lượng mặt', '1.500', 2),
((SELECT id FROM products WHERE legacy_id = 7), 'Tốc độ nhận diện', '<0.5 giây', 3),
((SELECT id FROM products WHERE legacy_id = 7), 'Màn hình', '7 inch cảm ứng', 4),
((SELECT id FROM products WHERE legacy_id = 8), 'Số đầu báo', '8 đầu báo khói', 1),
((SELECT id FROM products WHERE legacy_id = 8), 'Loại', 'Báo khói quang + nhiệt', 2),
((SELECT id FROM products WHERE legacy_id = 8), 'Còi báo', '85dB', 3),
((SELECT id FROM products WHERE legacy_id = 8), 'Tiêu chuẩn', 'PCCC Việt Nam', 4);
