...
const SEOSettingsPage = () => {
  ...
  const handleSave = async () => {
    try { await update.mutateAsync({ key: "seo_defaults", value: form as unknown as Record<string, unknown> }); toast.success("Đã cập nhật SEO"); } catch (err: unknown) { toast.error(getErrorMessage(err)); }
  };
